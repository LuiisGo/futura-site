...
const nextConfig = {
  ...
  async headers() {
    ...
    const cspDirectives = [
      ...
      "img-src 'self' data: https://www.google-analytics.com https://www.googletagmanager.com https://*.googleapis.com",
      "font-src 'self'",
      "connect-src 'self' https://www.google-analytics.com https://www.googletagmanager.com https://analytics.google.com",
      "frame-src 'self' https://tally.so https://futura-wallet.onrender.com https://calendar.app.google https://calendar.google.com",
