  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#362263] via-[#362263] to-[#3C88BA] text-white">
      ...
      <div className="relative max-w-6xl mx-auto px-4 py-20 md:py-28 flex flex-col md:flex-row items-center gap-12">
        ...
        >
          <div className="relative bg-white/5 backdrop-blur-md border border-white/20 rounded-3xl p-4 md:p-5 shadow-2xl max-w-md ml-auto">
            <div className="flex items-center justify-between mb-3">
              <span className="text-xs font-semibold text-slate-100">
                Snapshot FUTURA
              </span>
              <span className="text-[10px] px-2 py-1 rounded-full bg-[#3C88BA] text-white font-semibold">
                LIVE DATA
              </span>
            </div>
            <div className="space-y-3 text-xs text-slate-100/90">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold text-emerald-300">+180h</span>
              </div>
            </div>
            <div className="mt-4 border-t border-white/15 pt-3">
              <p className="text-[11px] text-slate-100/80 mb-2">
                “Por primera vez puedo ver mis números en un solo lugar.”
              </p>
              <p className="text-[10px] text-slate-100/60">
                Director General — PYME láctea (ejemplo)
              </p>
            </div>
          </div>
        </motion.div>
